...
#you can see the dns solution. Using the describe command you can see configuration file location for dns configs. See configmap related to dns to know which is root domain/zone.
